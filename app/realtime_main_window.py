...
class Ui_RealtimeMainWindow(object):
    def setupUi(self, RealtimeMainWindow):
        ...
        RealtimeMainWindow.resize(1300, 842)
        ...
        self.groupBox_Camera.setMinimumSize(QtCore.QSize(600, 620))
        self.groupBox_Camera.setMaximumSize(QtCore.QSize(600, 620))
        ...
        self.groupBox_Detection.setMinimumSize(QtCore.QSize(600, 620))
        self.groupBox_Detection.setMaximumSize(QtCore.QSize(600, 620))
